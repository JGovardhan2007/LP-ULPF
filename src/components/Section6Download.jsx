...
const DOWNLOAD_OPTIONS = [
  {
    ...
    arch: 'x86_64 / ARM64',
    pkg: 'ulpf-container-release.zip',
    size: '14.8 MB',
...
export default function Section6Download() {
  ...
  return (
    ...
    >
      {/* Top Header: Title "Download" with Clean Underline */}
      <div
        style={{
          width: '100%',
          padding: '0 48px',
        ...
        >
          {DOWNLOAD_OPTIONS.map((opt, idx) => (
            ...
            >
              ...
              {/* Download Button */}
              <a
                href="/assets/downloads/ulpf-container-release.zip"
                download="ulpf-container-release.zip"
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  justifyContent: 'center',
              ...
              >
                ...
                <span style={{ fontSize: '0.75rem', opacity: 0.7 }}>({opt.size})</span>
              </a>
